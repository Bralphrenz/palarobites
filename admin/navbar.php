...
<nav id="sidebar" class="fixed top-0 left-0 h-screen w-64 bg-gradient-to-b from-gray-900 to-gray-800 border-r border-gray-700 shadow-2xl z-40 flex flex-col">
  ...
  <div class="mb-6 px-4">
      <!-- <a href="../index.php"
         class="w-full flex items-center justify-center px-4 py-3 bg-gray-700/50 border border-yellow-600/50 text-yellow-400 rounded-lg hover:bg-yellow-600 hover:text-gray-900 hover:border-yellow-600 transition-all duration-300 text-sm font-semibold shadow-lg mb-2"
